...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        chat : $('<a>'+options.labelChat+'</a>').attr("href","#").addClass("buttonChat").addClass("buttonHidden")
    };
    ...
    var _init = function($this) {
        ...
        elmActionBar.append($this.buttons.next).append($this.buttons.chat)
        ...
        $($this.buttons.chat).click(function() {
			if($.isFunction($this.options.onChat)) {
				if(!$this.options.onChat.call(this,$($this.steps))){
					return false;
				}
            }
            return false;
...
// Default Properties and Events
    $.fn.smartWizard.defaults = {
		...
		onChat: null,  // triggers when Chat button is clicked
