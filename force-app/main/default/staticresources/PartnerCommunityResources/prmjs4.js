...
//		alert('JQUERY');
	...
	$("#side-toolkit .toolkit-links a.blogs").click(function(){
		$("#twitter-overlay, #facebook-overlay, #blogs-overlay, #share-overlay").hide();
	...
	$("#side-toolkit .toolkit-links a.facebook").click(function(){
		$("#twitter-overlay, #blogs-overlay, #share-overlay").hide();
	...
	$("#side-toolkit .toolkit-links a.twitter").click(function(){
		$("#facebook-overlay, #blogs-overlay, #share-overlay").hide();
	...
	$("#side-toolkit .toolkit-links a.share").click(function(){
		$("#twitter-overlay, #facebook-overlay, #blogs-overlay").hide();
